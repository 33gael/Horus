site_list = {
    ...
    "Chess.com": "https://chess.com/member/${username}",
    "Lichess": "https://lichess.org/@/${username}",
    "Speedrun.com": "https://speedrun.com/user/${username}",
    ...
    "Bento": "https://bento.me/${username}",
    "Wikipedia": "https://en.wikipedia.org/wiki/User:${username}",
    "Wikipedia (FR)": "https://fr.wikipedia.org/wiki/Utilisateur:${username}",
